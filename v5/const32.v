...
//lpm_constant CBX_AUTO_BLACKBOX="ALL" ENABLE_RUNTIME_MOD="NO" LPM_CVALUE=3FEF9DB2 LPM_WIDTH=32 result
...
module  const32_lpm_constant_g99
	( 
	result) ;
	output   [31:0]  result;
	...
	assign
		result = 32'b00111111111011111001110110110010;
endmodule //const32_lpm_constant_g99
//VALID FILE
...
module const32 (
	...
	const32_lpm_constant_g99	const32_lpm_constant_g99_component (
				.result (sub_wire0));
