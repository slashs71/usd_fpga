...
//lpm_constant CBX_AUTO_BLACKBOX="ALL" ENABLE_RUNTIME_MOD="YES" INSTANCE_NAME="fnco" LPM_CVALUE=20041893 LPM_WIDTH=32 result
...
module  cnst_nco_lpm_constant_62b
	( 
	result) ;
	output   [31:0]  result;
	...
	defparam
		mgl_prim1.cvalue = 32'b00100000000001000001100010010011,
		mgl_prim1.is_data_in_ram = 0,
		mgl_prim1.is_readable = 0,
		mgl_prim1.node_name = 1718510447,
...
endmodule //cnst_nco_lpm_constant_62b
//VALID FILE
...
module cnst_nco (
	...
	cnst_nco_lpm_constant_62b	cnst_nco_lpm_constant_62b_component (
				.result (sub_wire0));
